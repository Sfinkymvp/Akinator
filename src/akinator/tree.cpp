...
const char* DEFAULT_INPUT_FILE = "../data/akinator_tree";
const char* DEFAULT_OUTPUT_FILE = "../data/akinator_tree";
...
const char* status_messages[] = {
    ...
    GENERATE_STATUS_MESSAGE(TREE_INVALID_USER_CHOICE, "Invalid user choice value")
};
